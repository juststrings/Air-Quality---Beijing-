# Introduction
A quick back story; Mr Olanrewanju Oyinbooke posted this challenge on his twitter handle which I bookmarked and decided to get back to. Here is the analysis I carried out after I cleared the tasks on my table.
...
Analyze the dataset provided, seek insights and make recommendations to achieve the set objectives of a company in the environmental consulting industry which seeking to analyze the air quality in a specific city (Beijing) during hot and cold weather, during high-wind conditions and during precipitation. 
<br>
